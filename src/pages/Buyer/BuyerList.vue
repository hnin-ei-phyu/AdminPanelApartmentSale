  ...
  getFormattedDate: function (requiredDate) {
          ...
          return `${date.getDate()}/${
           ...
           readDataWithLimit : async function(page,itemsPerPage){
              ...
              let buyer = new Buyer();
              try {
                  var result = await buyer.getTotalCount()
                  ...
                  let range = {
                   ...
                   result = await buyer.getWithRange(range)
                   this.buyers = result.data.data;
                   this.loading = false;
              } catch (error) {
                  this.loading = false;
           ...
           searchItem:async function(){
              ...
              if(!this.search){
                ...
                this.readDataWithLimit(1,this.itemsPerPage)
                  ...
                  try {
                      let result = await buyer.search(this.search)
                      console.log(result.data)
           ...
           deleteItem : async function(){
              this.dialog = false;
              let buyer = new Buyer(this.toDelete)
              try {
                  await buyer.deleteBuyer(this.token)
              } catch (error) {
