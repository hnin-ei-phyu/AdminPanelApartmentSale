  ...
  getFormattedDate: function (requiredDate) {
          ...
          return `${date.getDate()}/${
           ...
           readDataWithLimit : async function(page,itemsPerPage){
              ...
              try {
                  var result = await seller.getTotalCount();
                  ...
                  let range = {
                   ...
                   result = await seller.getWithRange(range)
           ...
           searchItem:async function(){
              ...
              if(!this.search){
                ...
                this.readDataWithLimit(1,this.itemsPerPage)
                  ...
                  try {
                      let result = await seller.search(this.search)
                      console.log(result.data)
           ...
           deleteItem : async function(){
              this.dialog = false;
              let seller = new Seller(this.toDelete)
              try {
                  await seller.deleteSeller(this.token)
              } catch (error) {
